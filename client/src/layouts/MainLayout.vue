<template>
    <q-layout view="lHh Lpr lFf">
        ...
        <q-drawer :model-value="!layout.options.edit" class="side-panel column" :width="250" :overlay="false">
            <router-link :to="{ name: 'dashboard' }" class="hash-logo-link">
                <h1 class="logo">#</h1>
            </router-link>
            <q-space />
            <q-list class="q-py-lg q-px-lg" dense>
                ...
                <q-item class="q-pa-none">
                    <q-item-section>
                        <q-item-label class="menu-item group-title">Content</q-item-label>
                    </q-item-section>
                </q-item>
                <q-item>
                    <q-item-section>
                ...
                <q-item>
                    <q-item-section>
                        <q-item-label class="menu-item">Pages</q-item-label>
                    </q-item-section>
                </q-item>
                <q-item class="q-pa-none">
                    <q-item-section>
                        <q-item-label class="menu-item group-title">Taxonomies</q-item-label>
                    </q-item-section>
                </q-item>
                <q-item>
                    <q-item-section>
            ...
            <q-list style="background: #fff2">
                <q-item>
                    ...
                    <q-item-section class="text-white">
                        ...
                        <q-item-label caption class="cursor-pointer" @click="logout">
                            Log out
                        </q-item-label>
                    </q-item-section>
                </q-item>
...
export default defineComponent({
    ...
    mounted() {
        const id1 = "01e4a8df-a8ec-4c3e-8350-242e48ce83a7"
        Object.assign(layout, { areas: this.$refs })
        authApi.testRelationships("tag", id1).then(console.log)
    }
})
</script>
