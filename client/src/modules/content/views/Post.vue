                ...
                <q-list dense class="q-pa-none">
                  <q-item>
                    ...
                    <q-item-section class="q-pa-none" dense>
                      <q-input
                        :model-value="post.record.options.visibility"
                              ...
                              <q-list class="text-body2 q-pt-sm">
                                <q-item class="q-px-none">
                                  <q-item-section avatar top style="min-width: 16px; padding-right: 10px;">
                                    <q-radio
                                      v-model="post.record.options.visibility"
                                      val="public"
                                      size="sm"
                                      dense
                                    />
                  ...
                  <q-item>
                    ...
                    <q-item-section class="q-pa-none" dense>
                      <q-select
                        v-model="post.record.options.template"
                        class="input-transparent"
                        dense
                        outlined
                        hide-bottom-space
...
export default {
  ...
  computed: {
    ...
    selectedTemplateLabel () {
      return this.templates.options[this.post.record.options.template]?.label
    },
    formatedRevisions () {
  ...
  methods: {
    async createPost () {
      ...
      const result = await contentApi.createEntry("post", {
        header,
        body,
        taxonomies,
        options
